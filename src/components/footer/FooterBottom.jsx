    ...
    <div className="container">
      <div className="footer-bottom">
        <div className="footer-contact">
          <h2 className="logo">olcha</h2>
          <p className="support-title">Qo‘llab-quvvatlash raqami</p>
          <p className="support-number">+998 (71) 202 202 1</p>
          <p className="location">📍 Qozitarnov, Toshkent</p>
          <p className="email">✉ info@olcha.uz</p>
        </div>
